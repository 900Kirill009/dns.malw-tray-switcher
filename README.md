...
Демонстрация работы
![demo](https://github.com/user-attachments/assets/9cf80c4c-fc56-4eeb-adf2-3f188b31f982)

## Функционал

-   **Быстрое переключение:** Меняйте DNS-серверы на заранее заданные (по умолчанию добавлен только dns.malw.link) или возвращайте автоматические настройки в два клика.
...
1.  Перейдите на страницу **[Релизы](URL_К_РЕЛИЗАМ_ВСТАВИТЕ_ПОЗЖЕ)**.
2.  Скачайте последнюю версию установщика (`DNS-Switcher-Installer.exe`).
